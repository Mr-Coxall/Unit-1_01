...
class NumberPad: UIControl {
    ...
    private func updateSwipeActions() {
        ...
        if allowsFloats {
            swipeButton.setPrimaryActionImage(UIImage(named: "Decimal"), accessibilityDescription: "Insert decimal point")
            swipeButton.setSecondaryActionImage(UIImage(named: "Negative Positive"), accessibilityDescription: "Change number's sign")
