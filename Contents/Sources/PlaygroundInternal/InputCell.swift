...
class InputCell: MessageCell, UITextViewDelegate {
    ...
    static let submitTitleString = NSAttributedString(string: "Submit", attributes: [NSFontAttributeName: UIFont.systemFont(ofSize: UIFont.labelFontSize, weight: UIFontWeightMedium)])
